...
MAIN_LOOP   ADD R4, R4, #0          ; test digit counter
            BRp SKIP_PROMPT         ; if digits already entered, skip prompt
            LEA R1, PROMPT_RDY
            LDR R0, R1, #0
            OUT
SKIP_PROMPT GETC                    ; only print > at start of new number
            LD R1, CR_VAL
            NOT R1, R1
            ADD R1, R1, #1
            ADD R1, R0, R1
            ...
            OUT                     ; echo character, but not x0A
